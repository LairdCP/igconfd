...
class CustomService(ConfigurationService):
    ...
    def config_button_press(self, press_type):
        ...
        if press_type == BUTTON_PRESS_SHORT and (
            self.greengrass_prov_state or self.edge_iq_prov_state
        ):
